...
import { CREATE_SUBTOPIC, GET_TOPIC } from '../lib/queries';
...
export function CreateSubtopicModal({ topicId, topicSlug, onClose, onCreated }: Props) {
  ...
  const [createSubtopic, { loading, error }] = useMutation(CREATE_SUBTOPIC, {
    ...
    onCompleted: (data) => {
      onCreated?.(data.createSubtopic.id);
      onClose();
    },
  });
      ...
      <div style={styles.overlay} onClick={onClose}>
        <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
          <div style={styles.header}>
            <h2 style={styles.title}>Opprett undertema</h2>
            <button style={styles.closeButton} onClick={onClose}>
              ×
            </button>
          </div>
          <div style={styles.loginPrompt}>
            Du må vaere logget inn med en verifisert konto for å opprette undertemaer.
          </div>
        </div>
      </div>
    );
      ...
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={styles.field}>
          ...
          <textarea
            ...
            placeholder="Kort beskrivelse av undertemaet..."
          />
        </div>
